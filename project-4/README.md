...
### Planning Requirements - Due Friday, October 7th, 2022
...
### Presentation Requirements - Mon, October 17th, 2022
...
☐ **App Description:** Contains a description of what the app does and optional background info.

☐ **User Stories:** All the requirements aligned with the user stories.

☐ **ERD:** Entity relationship diagram that aligned with the user stories.

☐ **Wireframe:** Initial UI diagram.
