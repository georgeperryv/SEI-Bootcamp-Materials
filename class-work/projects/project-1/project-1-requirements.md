...
### Planning - Due Monday, 8/8/22:

- You will share:

	☐ Your choice of game.

	☐ A wireframe of your "main" game screen. Use [whimsical](https://whimsical.com/).

	☐ Pseudocode for the overall game play.

### Presentation - Friday, 8/12/22 at 12:45pm PST (after scheduled lunch):
...
1. **Trivia**
3. **Solitaire**
4. **Battleship** (would require some AI to implement a computer opponent)
5. **Hangman**
