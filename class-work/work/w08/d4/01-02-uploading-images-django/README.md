...
This lesson's starter code picks up from the many-to-many models lesson - with the "unassociate a toy & cat" practice exercise implemented.

If your many-to-many code is working, you can continue working with that codebase, otherwise, sync your code:

- `git clone git@git.generalassemb.ly:SEI-Rancho-Cordova-3-21/cat-collector-django-uploading-images-to-aws.git`
