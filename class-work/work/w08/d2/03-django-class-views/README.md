...
```text
git clone git@git.generalassemb.ly:SEI-Rancho-Cordova-3-21/cat-collector-django-class-based-views.git
```

If your code is complete and working, you don't need to sync, otherwise: 
