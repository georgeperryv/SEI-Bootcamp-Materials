...
#### Pitch Deck - Presented By Your Team on Monday, 09/19/2022, 11:00 AM

☐ **Pitch your project** to the class with a [pitch deck](https://pitchdeck.io/pitch-deck/index) that includes:
...
### Project Presentations - Friday, 09/23/2022:

**Your entire team must participate in the presentation of the project.**

You will have approximately 20 minutes to present your project following these guidelines:
...
- Your instructors will be using the [Project 3 Code Review](https://git.generalassemb.ly/SEIR-7-25/class-work/blob/master/projects/project-3/project-3-code-review.pdf) form to determine whether or not the project passes all of the minimum requirements. (Please ignore the Pitch Deck requirement).
